        ...
        body: ListView(
          ...
          children: [
            ...
            _buildListTile(
                svg_img: 'bell',
                title: 'Notification',
                onTap: () => Navigator.push(context, SlideLeftRoute(page: const ProfileNotification())).then((value) => Provider.of<AuthProvider>(context, listen: false).fetchUserDetailApi())),
    ...
    return Column(
      ...
      children: [
        ...
        InkWell(
            ...
            child: Hero(tag: "hero_image", child: buildCircularNetworkImage(imageUrl: credentialsProvider?.dataResponse?.profileImageUrl ?? "", radius: 70.r))),
        height16,
        Text("${credentialsProvider?.dataResponse?.firstName ?? ""} ${credentialsProvider?.dataResponse?.lastName ?? ""}",
      ...
      child: ListTile(
        ...
        title: Text(title,
            style: CustomTextStyle.kTxtRegular
                .copyWith(fontSize: 16.sp, fontWeight: FontWeight.w400, color: title == "Logout" || title == "Delete Account" ? CustomColors.sErrorColor : CustomColors.sWhiteColor)),
                        ...
                        children: [
                          ...
                          Center(
                            child: Text(
                              ...
                              style: CustomTextStyle.kTxtBold.copyWith(fontSize: 18.sp, fontWeight: FontWeight.w700, color: CustomColors.sWhiteColor, fontFamily: "SemiPlusJakartaSans"),
