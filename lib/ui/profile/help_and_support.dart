...
class _HelpAndSupportScreenState extends State<HelpAndSupportScreen> {
  ...
  Widget _buildKulean() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildExpandedList("What is Spraay?",
            "What is Spraay? is a one stop payment solution for individuals, businesses, marketplaces, and ecommerceplatforms. It allows you to make secure payments for goods and services."),
        height16,
        _buildExpandedList("What is Spraay?",
            "What is Spraay? is a one stop payment solution for individuals, businesses, marketplaces, and ecommerceplatforms. It allows you to make secure payments for goods and services."),
        height16,
