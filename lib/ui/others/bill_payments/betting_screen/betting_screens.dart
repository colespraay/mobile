...
class _BettingScreenState extends State<BettingScreen> {
  ...
  fetchverifyElectricityUnitPurchaseApi(BuildContext context ,String provider,String meterNumber,String amount, String plan ) async{
    ...
    if(result['error'] == true){
      ...
      Navigator.push(context, SlideLeftRoute(page: PinForBillPayment(
        title: widget.title, image: imageAirtime, amount: amount,
        provider: imageAirtime.replaceAll("_", "").toUpperCase(),
        phoneController: phoneController.text,
        providerGameIdCode: provider,billerName: result["billerName"],
        plan: plan,
            ...
            child:  ListView(
              ...
              children: [
                ...
                CustomizedTextField(textEditingController:phoneController, keyboardType: TextInputType.phone,
                  maxLength: 11,
                  textInputAction: TextInputAction.next,hintTxt: "Meter Number" ,focusNode: _textField1Focus,
                  inputFormat: [
