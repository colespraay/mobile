...
class _WalletViewState extends State<WalletView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // shrinkWrap: true,
      children: [buildWalletContainer(), height30, buildHorizontalContainer(), height40, Expanded(child: buildTransactionList())],
    ));
  }
  ...
  Widget buildTransactionList() {
    return Column(
      ...
      children: [
        ...
        height16,
        Expanded(child: MiniTransactionHistory(assetsList: eventProvider?.transactionList))
      ],
    );
  }
