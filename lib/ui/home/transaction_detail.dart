...
class _TransactionDetailState extends State<TransactionDetail> {
  ...
  Widget buildContainer() {
    return Screenshot(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: CustomColors.sDarkColor2, borderRadius: BorderRadius.all(Radius.circular(23.r))),
        child: Column(
          ...
          children: [
            ...
            height8,
            if (widget.transactionList?.bankName != null)
              ...(widget.transactionList?.others() ?? {}).entries.map((entry) {
                return Padding(
  ...
  Widget buildRow({required String title, required String content}) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.center,
      children: [
        SizedBox(width: 130.w, child: Text(title, style: CustomTextStyle.kTxtRegular.copyWith(fontSize: 12.sp, fontWeight: FontWeight.w400))),
        Spacer(),
