        ...
        Expanded(
          child: GestureDetector(
            ...
            child: Container(
                ...
                child: Center(child: Text("Ongoing", style: CustomTextStyle.kTxtRegular.copyWith(fontSize: 12.sp, color:currentIndex==0? CustomColors.sGreyScaleColor900: CustomColors.sGreyScaleColor500,
        ...
        Expanded(
          child: GestureDetector(
            ...
            child: Container(
                ...
                child: Center(child: Text("My Events", style: CustomTextStyle.kTxtRegular.copyWith(fontSize: 12.sp,
