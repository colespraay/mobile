...
class UserPhoneWithNameContactModel {
  ...
  @override
  String toString() {
    return 'UserPhoneWithNameContactModel{success: $success, message: $message, code: $code, data: ${data.toString()}}';
  }
}
...
class UserPhoneWithNameContactDatum {
  ...
  @override
  String toString() {
    return 'UserPhoneWithNameContactDatum{id: $id, status: $status, dateCreated: $dateCreated, dateUpdated: $dateUpdated, email: $email, phoneNumber: $phoneNumber, formattedPhoneNumber: $formattedPhoneNumber, firstName: $firstName, lastName: $lastName, walletBalance: $walletBalance, uniqueVerificationCode: $uniqueVerificationCode, isNewUser: $isNewUser, role: $role, deviceId: $deviceId, authProvider: $authProvider, profileImageUrl: $profileImageUrl, bvn: $bvn, bankCustomerId: $bankCustomerId, virtualAccountName: $virtualAccountName, virtualAccountNumber: $virtualAccountNumber, bankName: $bankName, gender: $gender, flutterwaveUserKey: $flutterwaveUserKey, flutterwaveNarration: $flutterwaveNarration, dob: $dob, userTag: $userTag, transactionPin: $transactionPin, externalUserId: $externalUserId, allowPushNotifications: $allowPushNotifications, allowSmsNotifications: $allowSmsNotifications, allowEmailNotifications: $allowEmailNotifications, displayWalletBalance: $displayWalletBalance, enableFaceId: $enableFaceId}';
  }
}
