...
//
//     final joinEventModel = joinEventModelFromJson(jsonString);

import 'dart:convert';

JoinEventModel joinEventModelFromJson(String str) => JoinEventModel.fromJson(json.decode(str));

String joinEventModelToJson(JoinEventModel data) => json.encode(data.toJson());
