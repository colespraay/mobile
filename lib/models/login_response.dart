...
LoginResponse logoinResponseFromJson(String str) => LoginResponse.fromJson(json.decode(str));

String logoinResponseToJson(LoginResponse data) => json.encode(data.toJson());
...
class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
        ...
        bvn: json["bvn"],
        quidaxUserId: json['quidax_user_id'],
