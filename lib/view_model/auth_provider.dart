...
class AuthProvider extends ChangeNotifier {
  ...
  changeForgotPasswordEndpoint(context, String uniqueVerificationCode, String newPassword) async {
    ...
    if (result['error'] == true) {
      ...
      popupDialog(
          ...
          content: "You now have access to your account.",
  ...
  changeTransactionPinEndpoint(context, String transactionPin, String userId) async {
    ...
    if (result['error'] == true) {
      ...
      popupDialog(
          ...
          content: "You have successfully changed your transaction PIN.",
          buttonTxt: 'Great!',
          onTap: () {
            Navigator.pop(context);
            Navigator.pop(context);
  ...
  registerVerifyCodeEndpoint(context, String uniqueVerificationCode) async {
    ...
    if (result['error'] == true) {
      ...
      popupDialog(
          ...
          content: "You have successfully registered your account. Now let’s know you.",
          buttonTxt: 'Continue',
          onTap: () {
  ...
  verifyBvnCodeEndpoint(context, String userId, String bvn, {String? selfie}) async {
    setloading(true);
    var result = await apiResponse.verifyBvnCode(userId, bvn, MySharedPreference.getToken(), selfie: selfie);
    ...
    if (result['error'] == true) {
      ...
      popupDialog(
          ...
          content: "Yaay!!! You can now enjoy all the features of Spray App!",
  ...
  fetchLoginEndpoint(context, String password, String phoneNumber, String deviceId) async {
    ...
    if (result['error'] == true) {
      ...
      await MySharedPreference.saveToken(result["token"]);
      await MySharedPreference.saveQuidaxUserId(result["quidaxUserId"]);
  ...
  doBVNVerification(context, String profileImageUrl, String userId) async {
    setloading(true);
    var result = await apiResponse.uploadImageUrl(profileImageUrl, userId);
    if (result['error'] == true) {
      setloading(false);
