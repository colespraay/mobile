...
class TransactionProvider extends ChangeNotifier {
  ...
  fetchWithdrawalApi(BuildContext context, String bankName, String accountNumber, String bankCode, String transactionPin, String amount, String fromWhere, String accountName) async {
    setloading(true);
    ...
    if (result['error'] == true) {
      ...
      popupSuccessfulDialog(
          ...
          others: {
            ...
            'Account Name': result['data']['accountName'],
  ...
  fetchSavedBanksInfoApi() async {
    ...
    if (apiResponse.error == true) {
      savedBankList = [];
      print("fetchSavedBanksInfoApi=${apiResponse.errorMessage ?? ""}");
    } else {
