...
class CustomColors {
  ...
  static const Color sDarkBlue = Color(0xff1E1848);
  ...
  static const Color semanticFGMuted = Color(0xff757571);
  static const Color cardBg = Color(0xff2F3133);
  static const Color lightCardBg = Color(0xff1F2224);
}
